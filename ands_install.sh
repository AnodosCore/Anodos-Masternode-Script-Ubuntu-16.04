...
CONFIGFOLDER='/root/.anodoscore'
COIN_DAEMON='anodosd'
COIN_CLI='anodos-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/AnodosCore/AnodosCore/releases/download/untagged-ad3b09a94abbfcff639b/Anodos.Ubuntu.VPS.16.04.tar.gz'
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Windows Wallet Guide: ${PURPLE}https://github.com/AnodosCore/AnodosCore/blob/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 ...
 echo -e "${GREEN}anodos-cli getinfo. ${CYAN} Compare the Blocks line with the explorer to ensure the VPS is synced${NC}"
 echo -e "${GREEN}anodos-cli masternode status${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
